...
<p><?php 
 ...
 echo '<a href="'.base_url('index.php/Admin/site/adminlogout').'">LogOut</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="'.base_url('index.php/Admin/site/adminlogin').'">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="previouspage('.$roomid.','.$userid.','.$designid.')">Back</a>';
?></p>
