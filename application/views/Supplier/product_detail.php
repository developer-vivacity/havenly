...
if(!isset($title)){
	...
	echo "<img src={$href} class='active' height=150px>";
	echo '</div>';
	}
	...
	foreach ($images as $key=>$value){
		echo '<img class="active" src='.$value.' height=200px>';
		}	
	}
	else{
	foreach ($images as $key=>$value) 
	{
		echo '<img class="inactive" src='.$value.' height=200px>';
	}}
	
} ?>
<br><br>
<a class="flat" id = "submit_product">Submit and Save</a>
...
$(document).ready(function() {
	...
	$('#loading').hide();
		...
		$(".close1").click(function() {
			location.href='/test/design2/index.php/Supplier/response/show_upload';
			})	;
