...
<div id = "designlabel" class = "inline serif middle midlarge">Cart Total:  </div>
<span id="show_design_fee" class = "inline middle midlarge condensed pink_text"> $<?php echo $amount;?></span>
<br>.
</div>
		<BR><BR>
	...
	<hr class = "style">
	 <p class = "condensed small">SHIPPING INFORMATION</p>
	<div class="row text-left">
	<div for="shipname"  class = "span2 formlabel">Recipient Name: </div>
	<input type="text" name="shipname" value="Recipient Name" id="shipname" class = "span5 forminput middle"   onfocus="if(this.value==this.defaultValue){this.value=''}; return false;" onblur="if(this.value ==''){this.value =this.defaultValue};" />
	</div>	
	
	<div class="row text-left">
	<div for="shipaddress"  class = "span2 formlabel">Shipping Address: </div>
	<input type="text" name="shipaddress" value="Shipping Address" id="shipaddress" class = "span5 forminput middle"   onfocus="if(this.value==this.defaultValue){this.value=''}; return false;" onblur="if(this.value ==''){this.value =this.defaultValue};" />
	</div>	
	<div class="row text-left">
	<div for="shipcity"  class = "span2 formlabel">Shipping City: </div>
	<input type="text" name="shipcity" value="Shipping City" id="shipcity" class = "span5 forminput middle"  onfocus="if(this.value==this.defaultValue){this.value=''}; return false;" onblur="if(this.value ==''){this.value =this.defaultValue};" />
	</div>	
	<div class="row text-left">
	<div for="shipst"  class = "span2 formlabel">Shipping State: </div>
	<input type="text" name="shipst" value="Shipping State" id="shipst" class = "span5 forminput middle"  onfocus="if(this.value==this.defaultValue){this.value=''}; return false;" onblur="if(this.value ==''){this.value =this.defaultValue};" />
	</div>	
	
	
	<div class="row text-left">
	<div for="shipzip"  class = "span2 formlabel">Shipping Zipcode: </div>
	<input type="text" name="shipzip" value="Shipping Zipcode" id="shipzip" class = "span2 forminput middle"  maxlength="6"  onfocus="if(this.value==this.defaultValue){this.value=''}; return false;" onblur="if(this.value ==''){this.value =this.defaultValue};" />
	</div>
	<div class="row text-left">
	<div for="giftmsg"  class = "span2 formlabel">Gift Message: </div>
	<textarea name = "giftmsg" id = "giftmsg" style = "width:60%;" onfocus="if(this.value==this.defaultValue){this.value=''}; return false;" onblur="if(this.value ==''){this.value =this.defaultValue};" ></textarea>
	</div>
...
$("#card-name").val()==''||
$("#shipst").val()=='Shipping State'||
$("#shipst").val()==''||
$("#shipcity").val()=='Shipping City'||
$("#shipcity").val()==''||
$("#shipaddress").val()=='Shipping Address'||
$("#shipaddress").val()==''||
$("#shipzip").val()=='Shipping Zipcode'||
$("#shipzip").val()==''
)
{
   $(".continue2").hide();
