...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <link href="<?php echo base_url('theme/website/main.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('theme/website/top_nav.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('theme/website/home.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('theme/website/services.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('theme/website/video.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('theme/website/cost.css');?>" rel="stylesheet">
	...
	<link href="<?php echo base_url('theme/app/checkout.css');?>" rel="stylesheet">
    ...
    <script type="text/javascript" src="<?php echo base_url('theme/js/jquery.scrollTo.js');?>"></script>
    <script type="text/javascript" src="<?php echo base_url('theme/js/accordion.min.js');?>"></script>
